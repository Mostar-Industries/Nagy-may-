...
class RiskAnalysisRequest(Model):
    ...
    """
    def __init__(self, region: str=None, historical_data_url: str=None):  # noqa: E501
    ...
    def historical_data_url(self, historical_data_url: str):
